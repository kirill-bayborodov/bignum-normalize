/**
 * @file bignum_normalize_benchmark_adapter.h
 * @brief Public benchmark-framework adapter contract for bignum_normalize.
 ...
 */
#ifndef BIGNUM_NORMALIZE_BENCHMARK_ADAPTER_H
#define BIGNUM_NORMALIZE_BENCHMARK_ADAPTER_H
#include <benchmark_framework.h>
#ifdef __cplusplus
extern "C" {
#endif
/** @brief Named validation and callback-binding status. */
typedef enum bignum_normalize_benchmark_status {
    BIGNUM_NORMALIZE_BENCHMARK_STATUS_SUCCESS = 0,
    BIGNUM_NORMALIZE_BENCHMARK_STATUS_NULL_ARGUMENT = 1,
    BIGNUM_NORMALIZE_BENCHMARK_STATUS_INVALID_PROFILE = 2
} bignum_normalize_benchmark_status_t;
/**
 ...
 */
bignum_normalize_benchmark_status_t bignum_normalize_benchmark_adapter_init(
    benchmark_adapter_t *adapter);
#ifdef __cplusplus
}
#endif
#endif /* BIGNUM_NORMALIZE_BENCHMARK_ADAPTER_H */
